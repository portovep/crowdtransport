...
public class BusAuthentication extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bus_authentication);
	...
	private class AuthenticationAsyncTask extends AsyncTask<String, Void, ResultBundle> {
		...
		protected void onPreExecute () {
			...
			pdprocessingAuthentication = ProgressDialog.show(BusAuthentication.this, "", getString(R.string.processingUserAuthentication), true);
		}
